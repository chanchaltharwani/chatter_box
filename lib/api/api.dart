...
class APIs {
  ...
  // for accessing firebase messaging(push messageing)
      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'key=AAAAN-UT8Iw:APA91bEnMwpTFSAEzcyK7xYohizT_dUPEXo3xDrF0iRTXwN4awwjWsgEEASo0MhLzNTBCviKH27Ed6EBfWDZRgXa7jKd9NARuQFHIdyv_qxe74mrhlBMCT2vPA_OtELdmTeSZt-2Ot17'
          },
...
// check if user is exist or not
  ...
  //for getting id of  users from firestore database
